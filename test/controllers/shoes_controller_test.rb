...
class ShoesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shoe" do
    assert_difference('Shoe.count') do
      post shoes_url, params: { shoe: { brand: @shoe.brand, description: @shoe.description, picture: @shoe.picture, price: @shoe.price, release_date: @shoe.release_date, seller_id: @shoe.seller_id, size: @shoe.size } }
    end
  ...
  test "should update shoe" do
    patch shoe_url(@shoe), params: { shoe: { brand: @shoe.brand, description: @shoe.description, picture: @shoe.picture, price: @shoe.price, release_date: @shoe.release_date, seller_id: @shoe.seller_id, size: @shoe.size } }
